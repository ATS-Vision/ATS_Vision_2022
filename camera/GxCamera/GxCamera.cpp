...
#ifdef _ENABLE_AVI
    threadParam.outputVideo = &(this->outputVideo);
#endif
    threadParam.timestamp = &(this->time_start);
...
void GxCamera::ProcGetImage(void *pAcquisitionThread) {
    ...
    struct timeval *time_start = threadParam->timestamp;
