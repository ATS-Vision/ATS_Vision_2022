...
bool show_info = false;        // 仅终 端显示目标信息
bool run_by_frame = false;     // 图像源仅使用视频流
bool recv_close = true; // 手动设置目标装甲板颜色 【true:自身红色，目标蓝色 false：自身蓝色】
bool armor_predictor = true;  // 目标预测器
